...
//(a) Home Team name for 2014 world cup final
      const wcFinals2014 = fifaData.filter((item) => {
        return item.Year === 2014 && item.Stage === 'Final';
      });
      console.log(wcFinals2014);
      console.log(wcFinals2014[0]["Home Team Name"]);

//(b) Away Team name for 2014 world cup final
      console.log(wcFinals2014[0]["Away Team Name"]);

//(c) Home Team goals for 2014 world cup final
      console.log(wcFinals2014[0]["Home Team Goals"]);

//(d) Away Team goals for 2014 world cup final
      console.log(wcFinals2014[0]["Away Team Goals"]);

//(e) Winner of 2014 world cup final */
      console.log(wcFinals2014[0]["Win conditions"]);
...
function getFinals(fifaData) {
    const finalTeams = fifaData.filter((item) => {
...
function getWinners(fifaData, getFinals) {
    return getFinals(fifaData).map(item => item['Home Team Goals'] > item['Away Team Goals'] ?
